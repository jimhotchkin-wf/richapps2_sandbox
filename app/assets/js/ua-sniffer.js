(function() {
	...
	var BrowserDetect = {
		...
		window.$.client = { os : BrowserDetect.OS, browser : BrowserDetect.browser, version : BrowserDetect.version.toString(), userAgent : BrowserDetect.userAgent, vendor : BrowserDetect.vendor, platform : BrowserDetect.platform, device : BrowserDetect.device };
