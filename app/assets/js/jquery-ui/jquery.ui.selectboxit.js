...
(function ($, window, document, undefined) {
    ...
    $.widget("selectBox.selectBoxIt", {
        ...
        _replaceSelectBox: function() {
            ...
            var maxWidth = self.dropdownContainer.width() - (self.downArrowContainer.outerWidth(true) + self.dropdownImage.outerWidth(true));
            if(maxWidth > 0) {
